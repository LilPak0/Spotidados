  ...
  return (
    <div className="bg-[url(/main_background.png)] bg-cover bg-center h-dvh">
      ...
      <div className="absolute top-[782px] left-[180px] flex justify-center ">
        <button className="bg-gradient-to-br from-gray-700 to-gray-300 w-[80px] h-[80px] rounded-[15%] flex items-center justify-center shadow-[2px_5px_5px_rgba(0,0,0,0.4)]">
